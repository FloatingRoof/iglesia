    ...
    <div class="wrapper">
        ...
        <div class="contacts_data cf">
            <div class="third_part">
                <span class="label"><i class="fas fa-phone"></i> <?php echo ale_get_meta('phone_label'); ?></span>
                <span class="value phone_number"><a href="tel:<?php echo ale_get_meta('phone_number'); ?>"><?php echo ale_get_meta('phone_number'); ?></a></span>
            </div>
            <div class="third_part">
                <span class="label"><i class="fas fa-globe-europe"></i></i> <?php echo ale_get_meta('address_label'); ?></span>
